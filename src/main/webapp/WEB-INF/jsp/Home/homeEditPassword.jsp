    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${ctx}/homeEditPasswordSkip.do" class="list-group-item active"><strong>修改密码</strong></a>
    ...
    $(function() {
        ...
        $('#submit').click(function () {
            ...
            if(isNPwOk == "true" && isRPwOk == "true"){
                jQuery.ajax({
                    data: {id: id, oldPassword: oldPassword, newPassword: newPassword, repeatPassword: repeatPassword},
                    url: "${ctx}/editPassword.do",
                    type: "POST",
