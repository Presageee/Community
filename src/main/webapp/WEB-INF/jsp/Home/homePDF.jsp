    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${ctx}/homePDFSkip.do" class="list-group-item active"><strong>我的PDF</strong></a>
...
<%--                <c:forEach items="${PDFList}" var="pdf" varStatus="status">
                    <tr>
                        <td scope="row" class="col-md-2" style="text-align: center;">${pdf.id}</td>
                        <td class="col-md-5" style="text-align: center;"><a href="#">${pdf.name}</a></td>
                        <td class="col-md-2" style="text-align: center;">${pdf.type}</td>
                        <td class="col-md-3" style="text-align: center;">${pdf.time}</td>
                    </tr>
                </c:forEach>--%>
            </table>
            <div class="col-md-12" id="buttonDiv">
                <button class="btn btn-default" style="margin-left: 45%;margin-right: auto;" id="addPDF">查看更多</button>
            </div>
        </div>
    </div>
</div>
            ...
            success: function (data) {
                ...
                if (data && data.success == "true"){
                    for(i = 0; i < data.pdf.length; i++){
                        addPDF += "<tr>";
                        addPDF += "<th scope='row' class='col-md-2' style='text-align: center;'>" + data.pdf[i].id + "</td>";
                        addPDF += "<td class='col-md-4' style='text-align: center;'><a href='#'>" + data.pdf[i].name + "</a></td>";
                        addPDF += "<td class='col-md-2' style='text-align: center;'>" + data.pdf[i].type + "</td>";
                        addPDF += "<td class='col-md-4' style='text-align: center;'>" + data.pdf[i].time + "</td>";
                        addPDF += "</tr>";
                    }
                    $('#tb').append(addPDF);
                    if(i < 16){
                        var _hidden = document.getElementById("addPDF");
