    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${ctx}/homeTopicSkip.do" class="list-group-item active"><strong>我的提问</strong></a>
            </div>
        </div>
        <div class="col-md-10" style="background-color: #eeeeee; min-height:86.5%">
            <input type="hidden" id="userId" value="${user.id}"/>
            <h3>我的提问共有${user.topiccnt}个，这么少果然不喜欢学习！</h3>
            ...
            <div class="col-md-12" id="buttonDiv">
                <button class="btn btn-default" style="margin-left: 45%;margin-right: auto;" id="addTopic">查看更多</button>
            </div>
        </div>
    </div>
</div>
            ...
            success: function (data) {
                ...
                if (data && data.success == "true"){
                    for(i = 0; i < data.topics.length; i++){
                        addReply += "<tr>";
                        addReply += "<th scope='row' class='col-md-2' style='text-align: center;'>" + (i + 1) + "</td>";
                        addReply += "<td class='col-md-5' style='text-align: center;'><a href='${ctx}/topicPages.do?topicId=" + data.topics[i].id + "'>" + data.topics[i].title + "</a></td>";
                        addReply += "<td class='col-md-5' style='text-align: center;'>" + data.topics[i].time + "</td>";
                        addReply += "</tr>";
                    }
                    $('#tb').append(addReply);
                    if(i < 16){
                        var _hidden = document.getElementById("addTopic");
