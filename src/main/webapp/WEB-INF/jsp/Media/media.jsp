    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${ctx}/MediaSkip.do">视频</a></li>
...
<div class="container" style="background: white; ">
    <div class="row" >
        ...
        <form style="padding-top:1em" action="searchMediaByKey.do" method="post">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="margin-bottom:1.4em; padding-top:.4em;" >
            <span>最近热搜：</span>
            <a href="${ctx}/searchMediaByKey.do?search=Algorithms"><span class="label label-primary" style="margin-right:.5em">Algorithms</span></a>
            <a href="${ctx}/searchMediaByKey.do?search=PHP"><span class="label label-info" style="margin-right:.5em">PHP7</span></a>
            <a href="${ctx}/searchMediaByKey.do?search=C#"><span class="label label-danger" style="margin-right:.5em">C#</span></a>
            <a href="${ctx}/searchMediaByKey.do?search=Javascript"><span class="label label-success" style="margin-right:.5em">Javascript</span></a>

        </div>
        <div class="col-md-2">
            <button class="btn btn-default" type="button" id="uploadMedia">我为社区出份力(我要上传)</button>
        </div>
        <div class="col-md-2"></div>
    </div>
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="col-md-12" id="buttonDiv">
                <button class="btn btn-default" style="margin-left:42%;margin-right:auto;    display: none;" id="moreSearchMedia">查看更多</button>
            </div>
        </div>
        <div class="col-md-1"></div>
    </div>
...
<script>
    var x = 1;
    var y = 2;
    var searchMediaKey = "${searchMediaKey}";
    function load(){
        if (searchMediaKey == null){
            searchMediaKey = "";
        } else {
            $('#search').attr("value", searchMediaKey);
        }
        console.log(searchMediaKey);
        jQuery.ajax({
            url: "${ctx}/searchMedia.do" ,
            data: {index: x, key: searchMediaKey},
            type: "POST",
            success: function (data){
                if (data && data.success == "true") {
                    ...
                    for(i = 0; i < data.medias.length; i++){
                        addResults += "<a href='${ctx}/RedirectMediaPlayer.do?mediaId=" + data.medias[i].id + "'><li class='list-group-item'>";
                        addResults += "<span class='badge'>" + data.medias[i].time + "</span>";
                        addResults +=  data.medias[i].name + " </li></a> <br>";
                    }
                    console.log(addResults);
                    $('#resultsList').append(addResults);
                    var _hidden2 = document.getElementById("moreSearchMedia");
                    _hidden2.style.display="inline-block";
                    if (i == 0 || i < 15){
                        var _hidden = document.getElementById("moreSearchMedia");
    ...
    $('#moreSearchMedia').click( function() {
        jQuery.ajax({
            url: "${ctx}/searchMedia.do" ,
            data: {index: y, key: searchMediaKey},
            type: "POST",
            success: function (data){
                if (data && data.success == "true") {
                    console.log(data.success);
